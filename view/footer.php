    ...
    <div class="container">
            ...
            <div class="col footer-column-1 mb-sm--42">
                <div class="footer-widget">
                    ...
                    <div class="address-widget">
                        <address>số 8, Trịnh Văn Bô, Từ Liêm, Hà Nội</address>
                        <a href="#">02456789</a>
                        <a href="#">payneShop@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row ptb--20">
            <div class="col-12 text-center">
                <p class="copyright-text">&copy; du an 1 nhom 10 <i class="fa fa-heart"></i> By
                    Hasthemes</p>
        ...
        <div class="mini-cart-inner">
            ...
            <div class="mini-cart__content">
                <ul class="mini-cart__list">
                    <li class="mini-cart__product">
                        ...
                        <div class="mini-cart__product-image">
                            <img src="img/products/product-13-90x90.jpg" alt="products" />
                        </div>
                ...
                <div class="mini-cart__buttons">
                    <a href="index.php?act=giohang" class="btn btn-fullwidth btn-bg-primary mb--20">Xem Giỏ Hàng</a>
                    <a href="index.php?act=thanhtoan" class="btn btn-fullwidth btn-bg-primary">Mua Hàng</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="element-carousel slick-vertical-center" data-slick-options='{
                            ...
                            <div class="item">
                                <figure class="product-gallery__image">
                                    <img src="img/products/product-03-270x300.jpg" alt="Product" />
                                    <span class="product-badge sale">Sale</span>
                                </figure>
                            </div>
                            <div class="item">
                                <figure class="product-gallery__image">
                                    <img src="img/products/product-04-270x300.jpg" alt="Product" />
                                    <span class="product-badge sale">Sale</span>
                                </figure>
                            </div>
                            <div class="item">
                                <figure class="product-gallery__image">
                                    <img src="img/products/product-05-270x300.jpg" alt="Product" />
                                    <span class="product-badge sale">Sale</span>
                                </figure>
                            </div>
                            <div class="item">
                                <figure class="product-gallery__image">
                                    <img src="img/products/product-06-270x300.jpg" alt="Product" />
                                    <span class="product-badge sale">Sale</span>
                                </figure>
                            </div>
                        </div>
...
<!-- Mirrored from htmldemo.net/payne/payne/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Nov 2024 10:17:00 GMT -->
