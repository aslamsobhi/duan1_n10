(function ($) {
  ...
  var $html = $("html"),
    ...
    $mainHeaderHeight = $headerInner.elExists()
      ? $headerInner[0].getBoundingClientRect().height
      : 0,
  ...
  $(window).on("scroll", function () {
    ...
    if ($scroll > $position && $position > $headerTotalHeight) {
      ...
      $(".site-header .header--fixed").removeClass(
        "header--unpinned header--pinned"
      );
  ...
  if ($elementCarousel.elExists()) {
    ...
    $elementCarousel.each(function (index, element) {
      ...
      $("body").on(
        "shown.bs.tab",
        'a[data-bs-toggle="tab"], a[data-bs-toggle="tab"]',
        function (e) {
  ...
  videoPopup.magnificPopup({
    type: "iframe",
    closeMarkup:
      '<button type="button" class="custom-close mfp-close"><i class="flaticon-cross"></i></button type="button">',
  });
