...
<section class="page-title-area-2 bg-image" data-bg-image="img/bg/blog-breadcrumb.jpg">
    <div class="container">
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="col-lg-9">
                        ...
                        <article class="single-post mb--75 mb-md--55 pb--75 pb-md--55">
                            <header class="single-post__header">
                                <h2 class="single-post__title">Consult lorem Ipsum is simply dummy text of the printing
                                    and typesetting</h2>
                                <div class="single-post__media">
                                    <div class="element-carousel" data-slick-options='{
                                        ...
                                        <div class="item">
                                            <img src="img/blog/blog-07.jpg" alt="Blog Image" class="w-100">
                                            <a href="blog-details-image.html" class="item-overlay"></a>
                                        </div>
                                        <div class="item">
                                            <img src="img/blog/blog-08.jpg" alt="Blog Image" class="w-100">
                                            <a href="blog-details-image.html" class="item-overlay"></a>
                                        </div>
                                        <div class="item">
                                            <img src="img/blog/blog-09.jpg" alt="Blog Image" class="w-100">
                                            <a href="blog-details-image.html" class="item-overlay"></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-post__info">
                                <div class="row mb--43 mb-md-33">
                                    <div class="col-lg-4 col-md-4 pl--45 pl-sm--15">
                                        <div class="single-post__meta">
                                            ...
                                            <div class="social social-rounded">
                                    ...
                                    <div class="col-lg-8 col-md-8">
                                        <p>Lorem Ipsum is simply du of the printing and typesetting industry. Lorem
                                            Ipsum has been the industry's standard dummy ever since the 1500s, when an
                                            unknown printer took a galley of type</p>
                                        <p>It is a long established fact that a reader will be distracted by the
                                            readable con a page when looking at its layout. The point of using Lorem
                                            Ipsum is that it has a more-or-l normal distribution of letters, as opposed
                                ...
                                <div class="row mb--80">
                                    <div class="col-md-6 mb-sm--40">
                                        <figure>
                                            <img src="img/blog/blog-01.jpg" alt="blog details" class="w-100">
                                        </figure>
                                    </div>
                                    <div class="col-md-6">
                                        <figure>
                                            <img src="img/blog/blog-02.jpg" alt="blog details" class="w-100">
                                        </figure>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-9 offset-lg-3">
                                        ...
                                        <p>It is a long established fact that a reader will be distracted by the
                                            ...
                                            English. Many desktop publishing packages and web</p>
                                    </div>
                                </div>
                            </div>
                        </article>
                        ...
                        <section class="comment">
                            ...
                            <ul class="comment-list mb--45">
                                <li>
                                    <div class="single-comment">
                                        <figure class="comment-avatar">
                                            <img src="img/others/avatar-large-2.jpg" alt="Avatar">
                                        </figure>
                                        <div class="comment-info">
                                            ...
                                            <div class="comment-content">
                                                <p>Hi, this is a comment. <br> To delete a comment, just log in and view
                                                    the post's comments. There you will have the option to edit or
                                                    delete them.</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="single-comment">
                                        <figure class="comment-avatar">
                                            <img src="img/others/comment-1.jpg" alt="Avatar">
                                        </figure>
                                        <div class="comment-info">
                                            <div class="comment-meta">
                                                <h4>Carlos</h4>
                                    ...
                                    <ul class="children">
                                        <li>
                                            <div class="single-comment">
                                                <figure class="comment-avatar">
                                                    <img src="img/others/comment-2.jpg" alt="Avatar">
                                                </figure>
                                                <div class="comment-info">
                                                    <div class="comment-meta">
                                                        <h4>Admin</h4>
                                                    ...
                                                    <div class="comment-content">
                                                        <p>Hi, this is a comment. <br> To delete a comment, just log in
                                                            and view the post's comments. There you will have the option
                                        ...
                                        <li>
                                            <div class="single-comment">
                                                <figure class="comment-avatar">
                                                    <img src="img/others/comment-3.jpg" alt="Avatar">
                                                </figure>
                                                <div class="comment-info">
                                                    <div class="comment-meta">
                                                        <h4>Admin</h4>
                                ...
                                <form action="#" class="form comment-form">
                                    <div class="form__group mb--25 mb-sm--20">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <input type="url" name="comment_website" id="comment_website"
                                                    class="form__input" placeholder="Website">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form__group mb--25 mb-sm--20">
                                ...
                                <div class="related-post">
                                    <div class="related-post__inner">
                                        ...
                                        <div class="related-post__info">
                                            <h3 class="related-post__title"><a href="blog-details-image.html">Lorem
                                                    ipsum dolor sit amet.</a></h3>
